...
# === 加载模型 ===
model_path = "../../.cache/modelscope/hub/models/deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B"
...
def classify_news(text): 
    prompt = f"你是一个虚假新闻识别专家，请判断下面这段新闻是真新闻还是假新闻，只能用“真”或“假”回答，不要回答多余内容：\n\n{text.strip()}\n\n"
